...
import { Plus, Loader2, Package, EyeOff, Star } from 'lucide-react';
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {products.map(product => (
                        <Link
                            ...
                            className="border border-ink/8 rounded-xl overflow-hidden hover:border-ink/20 transition-colors group"
                        >
                            {/* Thumbnail */}
